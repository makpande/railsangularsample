...
//     //Ouris-user-or-emailvalidation .directive('isUserOrEmail',function($http,$timeout,$filter,$q){
//     // we're checking using the api `is_user` if the user // input is already a user
...
//     scope.$watch(attrs.ngModel, function(v) { if (checking) clearTimeout(checking);
//     var value = scope.ngModel.$viewValue;
//     checking = $timeout(function() { isUser(value).then(function(data) {
//     if (data.success) {
//     // Is a user
...
//     checking = null;
//     ctrl.$setValidity('isUserOrEmail', true); } else {
//     checking = null;
